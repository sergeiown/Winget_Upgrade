...
Програма робить невелику паузу після кожної окремої перевірки (перевірка оновлень, версія winget, застосування списку ігнорування), щоб нічого не проскакувало занадто швидко для читання. Після завершення виявлення пакетів програма повідомляє, скільки всього пакетів встановлено, скільки вже актуальні, скільки потребують оновлення і скільки ігнорується - навіть якщо оновлювати нічого - а потім виводить список пакетів, які буде оновлено, і знову робить паузу перед початком. Далі, перед кожним пакетом екран консолі очищується та показується заголовок з назвою пакета і його номером (наприклад, `[3/42]`), а також кольоровий прогрес-бар з орієнтовним часом завершення (ETA). Після обробки всіх пакетів виводиться кольоровий підсумок: скільки пакетів оновлено, скільки вже були актуальними, і які саме (якщо є) не вдалося оновити.
